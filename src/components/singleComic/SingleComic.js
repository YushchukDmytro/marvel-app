...
const SingleComic = () => {
	return (
		<div className="single-comic">
			<img src={uw} alt="UW" className="single-comic__img" />
			<div className="single-comic__info">
				<div className="single-comic__name">X-Men: Days of Future Past</div>
				...
				<a href="google.com" className="single-comic__back">
					Back to all
				</a>
		</div>
	)
